      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <section className="mb-10">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="mb-4 text-gray-700">
                Adaverc provides blockchain-based verification for Google Forms responses by:
              </p>
          ...
          <section className="mb-10">
            ...
            <div className="bg-red-50 rounded-lg p-6">
              <p className="text-gray-800 font-semibold">
                IN NO EVENT SHALL ADAVERC BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-100 rounded-lg p-6">
              ...
              <div className="text-gray-800">
                <p className="mb-2"><strong>Email:</strong> <a href="mailto:legal@adaverc.com" className="text-[#0033AD] hover:underline">legal@adaverc.com</a></p>
